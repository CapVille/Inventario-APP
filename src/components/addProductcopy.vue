<template>
    <div id="addProduct">
        ...
        <div class="agregar">
            <button v-on:click="procesarAgregarProduct">Agregar</button>
        </div>
...
import axios from 'axios';
    export default {
        ...
        methods: {
            ...
            procesarAgregarProduct: function(){
                let self = this
                axios.post("https://inventario-api-g2m3-6.herokuapp.com/product/",self.product)
                    .then((result)=>{
